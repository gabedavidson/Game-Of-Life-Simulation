...
// Cell class -> is it active/inactive, need to be able to access that info
// Grid class -> lots of functionality, manipulate/access my array in any way
// Simulation class -> i need to be able to run the simulation, checking neighbors
// main
//
// BoundaryModeManager classic
